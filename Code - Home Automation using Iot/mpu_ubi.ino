 ...
 * Define Constants
 ****************************************/
#define TOKEN "BBFF-0OtimNCB4iZm5qLF0KhrQOZAPMrand" // Your Ubidots TOKEN
...
ax = map(a.acceleration.x, -10, 10, 0, 100);             // AY = Y AXIS AND Y = 40 TO 77

ay = map(a.acceleration.y,-9,9,0,100);
  
  //float value1 = random(0,100);
  if (ax>30 && ax <70)
{
  client.add("bulb", ay);
